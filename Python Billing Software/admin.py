...
def about():
    messagebox.showinfo("About Billing Software",
        "This Software is Developed by Nachiket Rajesh Chopade by using Python.")
...
class Inventory:
    ...
    def update_product(self):
        if len(self.sel) == 1:
            ...
            page9.entry5.insert(0, valll[3])
            page9.entry6.insert(0, valll[6])
            page9.entry7.insert(0, valll[7])
...
class add_product:
    def __init__(self, top=None):
        ...
        self.entry7.place(relx=0.527, rely=0.646, width=374, height=30)
        self.entry7.configure(
            font="-family {Poppins} -size 12",
            relief="flat",
            validate="key",
            validatecommand=(self.r2, "%P")
                    ...
                    if edes:
                        if eadd:
                            if epass:
                                ...
                                db.commit()
                                messagebox.showinfo("Success!!", f"Employee ID: {emp_id} successfully added in database.", parent=e_add)
                                self.clearr()
                            else:
                    ...
                    if edes:
                        if eadd:
                            if epass:
                                ...
                                db.commit()
                                messagebox.showinfo("Success!!", f"Employee ID: {emp_id} successfully updated in database.", parent=e_update)
                                vall.clear()
